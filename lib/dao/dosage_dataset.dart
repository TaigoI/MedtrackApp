...
/*class DosageDataset {
  ...
  static Future<List<Map>> findByMedicationIdAndPresentationId(int medicationId, int presentationId) async {
    ...
    List<Map> resultSet = await MedicationsDatabaseHelper.db.rawQuery(query, [medicationId, presentationId]);
